...
export default function Hero() {
  ...
  return (
    <section className="relative w-full pt-15 pb-20 overflow-hidden min-h-[500px]">
      ...
      {/* Content */}
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 flex items-center min-h-[460px]">
        <div className="text-white w-full max-w-[620px]">
              ...
              <div className="bg-[#F3F4F6] rounded-lg px-4 py-3 w-full">
                <div className="flex flex-wrap md:flex-nowrap items-center gap-4">
                  ...
                  >
                    ...
                    {open && (
                      <div className="absolute top-8 left-10 bg-white shadow-md rounded-md w-15 border text-gray-900 text-[13px] z-10 font-bold">
                        {options.map((item, i) => (
                          <div
                            key={i}
                            onClick={() => {
